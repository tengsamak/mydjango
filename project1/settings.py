...
import django_heroku     #add for deploy
import dj_database_url   #add for deploy   
...
SECRET_KEY = 'django-insecure-3@g6)25%oe0-2jp8ksgkr6nv78(w1u*+1lgw&w9@$!+h+p_5o='
